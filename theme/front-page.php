...
<main class="min-h-screen">
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto max-w-[1300px]">
            <!-- Título -->
            <div class="text-center mb-24">
                <h2 class="text-[var(--color-primary)] text-3xl md:text-4xl font-semibold mb-2">Profesionales y <span class="text-[var(--color-secondary)] relative inline-block">CERCANOS</span></h2>
            </div>
